...
/**
 * new_node - Function create new_node in linked list
...
/**
 * free_q - Function free nodes at linked list
 * @head: Node of linked_list
 */
...
/**
 * _push - Function pushes a node into stack
 * @node: Type pointer of node of tree
 * @head: Type head node of in stack
 * @tail: Type tail node of in stack
 */
...
/**
 * binary_tree_is_complete - Function check if binary tree is complete
