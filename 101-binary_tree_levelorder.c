...
/**
 * binary_tree_depth - depth of specified node from root node
 * @tree: node to check depth from
...
/**
 * recursion - goes through complete tree and each stores each node
...
/**
 * binary_tree_levelorder - print the node element in order
 * @tree: root node
